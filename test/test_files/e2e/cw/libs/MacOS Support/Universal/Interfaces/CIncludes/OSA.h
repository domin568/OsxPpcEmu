...
NewOSACreateAppleEventUPP(OSACreateAppleEventProcPtr userRoutine);
  ...
  #ifdef __cplusplus
    inline OSACreateAppleEventUPP NewOSACreateAppleEventUPP(OSACreateAppleEventProcPtr userRoutine) { return (OSACreateAppleEventUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppOSACreateAppleEventProcInfo, GetCurrentArchitecture()); }
  #else
...
NewOSASendUPP(OSASendProcPtr userRoutine);
  ...
  #ifdef __cplusplus
    inline OSASendUPP NewOSASendUPP(OSASendProcPtr userRoutine) { return (OSASendUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppOSASendProcInfo, GetCurrentArchitecture()); }
  #else
...
#if !OPAQUE_UPP_TYPES
  #ifdef __cplusplus
    inline void DisposeOSACreateAppleEventUPP(OSACreateAppleEventUPP userUPP) { DisposeRoutineDescriptor((UniversalProcPtr)userUPP); }
  #else
...
#if !OPAQUE_UPP_TYPES
  #ifdef __cplusplus
    inline void DisposeOSASendUPP(OSASendUPP userUPP) { DisposeRoutineDescriptor((UniversalProcPtr)userUPP); }
  #else
...
#if !OPAQUE_UPP_TYPES
  #ifdef __cplusplus
    inline OSErr InvokeOSASendUPP(const AppleEvent * theAppleEvent, AppleEvent * reply, AESendMode sendMode, AESendPriority sendPriority, long timeOutInTicks, AEIdleUPP idleProc, AEFilterUPP filterProc, long refCon, OSASendUPP userUPP) { return (OSErr)CALL_EIGHT_PARAMETER_UPP(userUPP, uppOSASendProcInfo, theAppleEvent, reply, sendMode, sendPriority, timeOutInTicks, idleProc, filterProc, refCon); }
  #else
...
NewOSAActiveUPP(OSAActiveProcPtr userRoutine);
  ...
  #ifdef __cplusplus
    inline OSAActiveUPP NewOSAActiveUPP(OSAActiveProcPtr userRoutine) { return (OSAActiveUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppOSAActiveProcInfo, GetCurrentArchitecture()); }
  #else
...
#if !OPAQUE_UPP_TYPES
  #ifdef __cplusplus
    inline void DisposeOSAActiveUPP(OSAActiveUPP userUPP) { DisposeRoutineDescriptor((UniversalProcPtr)userUPP); }
  #else
...
#if !OPAQUE_UPP_TYPES
  #ifdef __cplusplus
    inline OSErr InvokeOSAActiveUPP(long refCon, OSAActiveUPP userUPP) { return (OSErr)CALL_ONE_PARAMETER_UPP(userUPP, uppOSAActiveProcInfo, refCon); }
  #else
...
OSACopyScript(
  ComponentInstance   scriptingComponent,
  OSAID               fromID,
  OSAID *             toID)                                   FIVEWORDINLINE(0x2F3C, 0x0008, 0x0105, 0x7000, 0xA82A);
...
OSADebuggerCreateSession(
  ...
  OSAID                 inScript,
  OSAID                 inContext,
  OSADebugSessionRef *  outSession)                           FIVEWORDINLINE(0x2F3C, 0x000C, 0x0901, 0x7000, 0xA82A);
...
OSADebuggerGetSessionState(
  ...
  AERecord *           outState)                              FIVEWORDINLINE(0x2F3C, 0x0008, 0x0902, 0x7000, 0xA82A);
...
OSADebuggerSessionStep(
  ComponentInstance    scriptingComponent,
  OSADebugSessionRef   inSession,
  OSADebugStepKind     inKind)                                FIVEWORDINLINE(0x2F3C, 0x0008, 0x0903, 0x7000, 0xA82A);
...
OSADebuggerDisposeSession(
  ComponentInstance    scriptingComponent,
  OSADebugSessionRef   inSession)                             FIVEWORDINLINE(0x2F3C, 0x0004, 0x0904, 0x7000, 0xA82A);
...
OSADebuggerGetStatementRanges(
  ComponentInstance    scriptingComponent,
  OSADebugSessionRef   inSession,
  AEDescList *         outStatementRangeArray)                FIVEWORDINLINE(0x2F3C, 0x0008, 0x0905, 0x7000, 0xA82A);
...
OSADebuggerGetBreakpoint(
  ...
  OSADebugSessionRef   inSession,
  UInt32               inSrcOffset,
  OSAID *              outBreakpoint)                         FIVEWORDINLINE(0x2F3C, 0x000C, 0x0910, 0x7000, 0xA82A);
...
OSADebuggerSetBreakpoint(
  ...
  OSADebugSessionRef   inSession,
  UInt32               inSrcOffset,
  OSAID                inBreakpoint)                          FIVEWORDINLINE(0x2F3C, 0x000C, 0x0911, 0x7000, 0xA82A);
...
OSADebuggerGetDefaultBreakpoint(
  ComponentInstance    scriptingComponent,
  OSADebugSessionRef   inSession,
  OSAID *              outBreakpoint)                         FIVEWORDINLINE(0x2F3C, 0x0008, 0x0912, 0x7000, 0xA82A);
...
OSADebuggerGetCurrentCallFrame(
  ComponentInstance       scriptingComponent,
  OSADebugSessionRef      inSession,
  OSADebugCallFrameRef *  outCallFrame)                       FIVEWORDINLINE(0x2F3C, 0x0008, 0x0906, 0x7000, 0xA82A);
...
OSADebuggerGetCallFrameState(
  ...
  AERecord *             outState)                            FIVEWORDINLINE(0x2F3C, 0x0008, 0x0907, 0x7000, 0xA82A);
...
OSADebuggerGetVariable(
  ...
  OSAID *                outVariable)                         FIVEWORDINLINE(0x2F3C, 0x000C, 0x0908, 0x7000, 0xA82A);
...
OSADebuggerSetVariable(
  ...
  OSADebugCallFrameRef   inCallFrame,
  const AEDesc *         inVariableName,
  OSAID                  inVariable)                          FIVEWORDINLINE(0x2F3C, 0x000C, 0x0909, 0x7000, 0xA82A);
...
OSADebuggerGetPreviousCallFrame(
  ...
  OSADebugCallFrameRef *  outPrevFrame)                       FIVEWORDINLINE(0x2F3C, 0x0008, 0x090A, 0x7000, 0xA82A);
...
OSADebuggerDisposeCallFrame(
  ComponentInstance      scriptingComponent,
  OSADebugCallFrameRef   inCallFrame)                         FIVEWORDINLINE(0x2F3C, 0x0004, 0x090B, 0x7000, 0xA82A);
...
OSADebuggerCountVariables(
  ...
  long *                 outVariableCount)                    FIVEWORDINLINE(0x2F3C, 0x0010, 0x090C, 0x7000, 0xA82A);
