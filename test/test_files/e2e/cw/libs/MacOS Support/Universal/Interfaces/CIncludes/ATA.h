...
NewATADispatchUPP(ATADispatchProcPtr userRoutine);
  ...
  #ifdef __cplusplus
    inline ATADispatchUPP NewATADispatchUPP(ATADispatchProcPtr userRoutine) { return (ATADispatchUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppATADispatchProcInfo, GetCurrentArchitecture()); }
  #else
...
#if !OPAQUE_UPP_TYPES
  #ifdef __cplusplus
    inline void DisposeATADispatchUPP(ATADispatchUPP userUPP) { DisposeRoutineDescriptor((UniversalProcPtr)userUPP); }
  #else
...
#if !OPAQUE_UPP_TYPES
  #ifdef __cplusplus
    inline OSErr InvokeATADispatchUPP(ataPB * pb, ATADispatchUPP userUPP) { return (OSErr)CALL_ONE_PARAMETER_UPP(userUPP, uppATADispatchProcInfo, pb); }
  #else
...
typedef CALLBACK_API_C( OSStatus , ATAPluginClose )(UInt32 refCon, RegEntryIDPtr aimRegEntry);
typedef CALLBACK_API_C( void , ATAPluginAction )(UInt32 refCon, ATAReqBlock *pb);
typedef CALLBACK_API_C( void , ATAPluginHandleBusEvent )(UInt32 refCon, UInt32 aimData);
typedef CALLBACK_API_C( Boolean , ATAPluginPoll )(UInt32 refCon, UInt32 interruptLevel, UInt32 *aimData);
typedef CALLBACK_API_C( void , ATAPluginEjectDevice )(UInt32 refCon);
typedef CALLBACK_API_C( void , ATAPluginDeviceLight )(UInt32 refCon, UInt32 whichDevice, UInt32 lightState);
typedef CALLBACK_API_C( void , ATAPluginDeviceLock )(UInt32 refCon, UInt32 whichDevice, UInt32 lockState);
