...
enum {
   ...
   * document window group, given a modality of kWindowModalityNone,
   * and given an activation scope of kWindowActivationScopeAll.
   * Available in Mac OS X after 10.1.x.
   */
 ...
 *      X after 10.1 supports the kWindowMenuIncludeRotate option; in
 *      earlier versions of Mac OS X, and in CarbonLib, you must pass
...
enum {
   ...
   * windows onscreen. Available in Mac OS X after 10.1.
   */
