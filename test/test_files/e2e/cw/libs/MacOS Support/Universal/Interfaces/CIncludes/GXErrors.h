...
enum {
  ...
  bitmap_rowBytes_must_be_specified_for_user_image_buffer = gxFirstSystemDebuggingError + 133
};
...
enum {
  ...
  layout_run_lengths_do_not_sum_to_text_length = gxFirstSystemDebuggingError + 149
};
...
NewgxUserErrorUPP(gxUserErrorProcPtr userRoutine);
  ...
  #ifdef __cplusplus
    inline gxUserErrorUPP NewgxUserErrorUPP(gxUserErrorProcPtr userRoutine) { return (gxUserErrorUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppgxUserErrorProcInfo, GetCurrentArchitecture()); }
  #else
...
NewgxUserWarningUPP(gxUserWarningProcPtr userRoutine);
  ...
  #ifdef __cplusplus
    inline gxUserWarningUPP NewgxUserWarningUPP(gxUserWarningProcPtr userRoutine) { return (gxUserWarningUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppgxUserWarningProcInfo, GetCurrentArchitecture()); }
  #else
...
NewgxUserNoticeUPP(gxUserNoticeProcPtr userRoutine);
  ...
  #ifdef __cplusplus
    inline gxUserNoticeUPP NewgxUserNoticeUPP(gxUserNoticeProcPtr userRoutine) { return (gxUserNoticeUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppgxUserNoticeProcInfo, GetCurrentArchitecture()); }
  #else
...
#if !OPAQUE_UPP_TYPES
  #ifdef __cplusplus
    inline void DisposegxUserErrorUPP(gxUserErrorUPP userUPP) { DisposeRoutineDescriptor((UniversalProcPtr)userUPP); }
  #else
...
#if !OPAQUE_UPP_TYPES
  #ifdef __cplusplus
    inline void DisposegxUserWarningUPP(gxUserWarningUPP userUPP) { DisposeRoutineDescriptor((UniversalProcPtr)userUPP); }
  #else
...
#if !OPAQUE_UPP_TYPES
  #ifdef __cplusplus
    inline void DisposegxUserNoticeUPP(gxUserNoticeUPP userUPP) { DisposeRoutineDescriptor((UniversalProcPtr)userUPP); }
  #else
...
EXTERN_API_C( void )
InvokegxUserErrorUPP(
  gxGraphicsError  status,
  long             refcon,
  gxUserErrorUPP   userUPP);
#if !OPAQUE_UPP_TYPES
  #ifdef __cplusplus
    inline void InvokegxUserErrorUPP(gxGraphicsError status, long refcon, gxUserErrorUPP userUPP) { CALL_TWO_PARAMETER_UPP(userUPP, uppgxUserErrorProcInfo, status, refcon); }
  #else
...
EXTERN_API_C( void )
InvokegxUserWarningUPP(
  gxGraphicsWarning  status,
  long               refcon,
  gxUserWarningUPP   userUPP);
#if !OPAQUE_UPP_TYPES
  #ifdef __cplusplus
    inline void InvokegxUserWarningUPP(gxGraphicsWarning status, long refcon, gxUserWarningUPP userUPP) { CALL_TWO_PARAMETER_UPP(userUPP, uppgxUserWarningProcInfo, status, refcon); }
  #else
...
EXTERN_API_C( void )
InvokegxUserNoticeUPP(
  gxGraphicsNotice  status,
  long              refcon,
  gxUserNoticeUPP   userUPP);
#if !OPAQUE_UPP_TYPES
  #ifdef __cplusplus
    inline void InvokegxUserNoticeUPP(gxGraphicsNotice status, long refcon, gxUserNoticeUPP userUPP) { CALL_TWO_PARAMETER_UPP(userUPP, uppgxUserNoticeProcInfo, status, refcon); }
  #else
