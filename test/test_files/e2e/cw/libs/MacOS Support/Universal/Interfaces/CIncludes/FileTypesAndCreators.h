...
enum {
  ...
  sigAdobePremiere              = FOUR_CHAR_CODE('PrMr'), /* was previously misspelled as sigAdobePremier*/
  ftAdobePremiereMovie          = FOUR_CHAR_CODE('MooV'), /* was previously misspelled as ftAdobePremierMovie*/
