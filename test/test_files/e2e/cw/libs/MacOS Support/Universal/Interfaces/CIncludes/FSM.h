...
enum {
  ...
  kFSMReadFork                  = 0x0051, /* Fork I/O calls dispatched by forkRefNum (ioRefNum) */
  ...
  kFSMCloseIterator             = 0x005B, /* Iterator calls are dispatched by upper two bytes of "iterator", */
  kFSMGetCatalogInfoBulk        = 0x005C, /* which is treated as an ioRefNum.  By convention, the lower two */
  kFSMCatalogSearch             = 0x005D, /* bytes of the FSIterator are zero, though this is not enforced. */
  kFSMMakeFSRef                 = 0x006E, /* Dispatched by ioVRefNum/ioDirID/ioNamePtr */
  kFSMCreateFileUnicode         = 0x0070, /* FSRef dispatched calls.  The first two bytes of an FSRef */
  kFSMCreateDirUnicode          = 0x0071, /* are a volume reference number (not a working directory reference */
  kFSMDeleteObject              = 0x0072, /* number or drive number).  The remaining bytes of the FSRef are */
...
NewLg2PhysUPP(Lg2PhysProcPtr userRoutine);
  ...
  #ifdef __cplusplus
    inline Lg2PhysUPP NewLg2PhysUPP(Lg2PhysProcPtr userRoutine) { return (Lg2PhysUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppLg2PhysProcInfo, GetCurrentArchitecture()); }
  #else
...
#if !OPAQUE_UPP_TYPES
  #ifdef __cplusplus
    inline void DisposeLg2PhysUPP(Lg2PhysUPP userUPP) { DisposeRoutineDescriptor((UniversalProcPtr)userUPP); }
  #else
...
NewHFSCIUPP(HFSCIProcPtr userRoutine);
  ...
  #ifdef __cplusplus
    inline HFSCIUPP NewHFSCIUPP(HFSCIProcPtr userRoutine) { return (HFSCIUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppHFSCIProcInfo, GetCurrentArchitecture()); }
  #else
...
#if !OPAQUE_UPP_TYPES
  #ifdef __cplusplus
    inline void DisposeHFSCIUPP(HFSCIUPP userUPP) { DisposeRoutineDescriptor((UniversalProcPtr)userUPP); }
  #else
...
#if !OPAQUE_UPP_TYPES
  #ifdef __cplusplus
    inline OSErr InvokeHFSCIUPP(VCBPtr theVCB, short selectCode, void * paramBlock, void * fsdGlobalPtr, short fsid, HFSCIUPP userUPP) { return (OSErr)CALL_FIVE_PARAMETER_UPP(userUPP, uppHFSCIProcInfo, theVCB, selectCode, paramBlock, fsdGlobalPtr, fsid); }
  #else
...
NewDICIUPP(DICIProcPtr userRoutine);
  ...
  #ifdef __cplusplus
    inline DICIUPP NewDICIUPP(DICIProcPtr userRoutine) { return (DICIUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppDICIProcInfo, GetCurrentArchitecture()); }
  #else
...
#if !OPAQUE_UPP_TYPES
  #ifdef __cplusplus
    inline void DisposeDICIUPP(DICIUPP userUPP) { DisposeRoutineDescriptor((UniversalProcPtr)userUPP); }
  #else
...
#if !OPAQUE_UPP_TYPES
  #ifdef __cplusplus
    inline OSErr InvokeDICIUPP(short whatFunction, void * paramBlock, void * fsdGlobalPtr, DICIUPP userUPP) { return (OSErr)CALL_THREE_PARAMETER_UPP(userUPP, uppDICIProcInfo, whatFunction, paramBlock, fsdGlobalPtr); }
  #else
...
NewFSDCommUPP(FSDCommProcPtr userRoutine);
  ...
  #ifdef __cplusplus
    inline FSDCommUPP NewFSDCommUPP(FSDCommProcPtr userRoutine) { return (FSDCommUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppFSDCommProcInfo, GetCurrentArchitecture()); }
  #else
...
#if !OPAQUE_UPP_TYPES
  #ifdef __cplusplus
    inline void DisposeFSDCommUPP(FSDCommUPP userUPP) { DisposeRoutineDescriptor((UniversalProcPtr)userUPP); }
  #else
...
#if !OPAQUE_UPP_TYPES
  #ifdef __cplusplus
    inline OSErr InvokeFSDCommUPP(short message, void * paramBlock, void * globalsPtr, FSDCommUPP userUPP) { return (OSErr)CALL_THREE_PARAMETER_UPP(userUPP, uppFSDCommProcInfo, message, paramBlock, globalsPtr); }
  #else
...
struct FSMGetIconRec {
  ...
  UInt8               iconType;               /* kind of icon. Note: A file system supporting kicnsIconFamily must */
