...
typedef CALLBACK_API_C( void , HIDStringHandlerProcPtr )(void *inHIDReport, UInt32 inHIDReportLength, UInt32 inRefcon, OSStatus inStatus);
/*
...
typedef CALLBACK_API_C( OSStatus , HIDGetSizedReportProcPtr )(HIDDeviceConnectionRef inConnectionRef, UInt32 inReportType, UInt32 inReportID, ByteCount inSize, HIDReportHandlerProcPtr inReportHandlerProc, UInt32 inRefcon);
...
*/
typedef CALLBACK_API_C( OSStatus , HIDGetIndexedStringProcPtr )(HIDDeviceConnectionRef inConnectionRef, UInt32 inStringIndex, UInt32 inStringLanguage, HIDStringHandlerProcPtr inStringHandlerProc, UInt32 inRefcon);
/*
