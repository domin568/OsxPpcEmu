...
NewResErrUPP(ResErrProcPtr userRoutine);
  ...
  #ifdef __cplusplus
    inline ResErrUPP NewResErrUPP(ResErrProcPtr userRoutine) { return (ResErrUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppResErrProcInfo, GetCurrentArchitecture()); }
  #else
...
#if !OPAQUE_UPP_TYPES
  #ifdef __cplusplus
    inline void DisposeResErrUPP(ResErrUPP userUPP) { DisposeRoutineDescriptor((UniversalProcPtr)userUPP); }
  #else
...
InvokeResErrUPP(
  ...
  #ifdef __cplusplus
    inline void InvokeResErrUPP(OSErr thErr, ResErrUPP userUPP) { CALL_ONE_PARAMETER_UPP(userUPP, uppResErrProcInfo, thErr); }
  #else
...
FSOpenResFile(
  const FSRef *  ref,
  SInt8          permission)                                  TWOWORDINLINE(0x7013, 0xA822);
