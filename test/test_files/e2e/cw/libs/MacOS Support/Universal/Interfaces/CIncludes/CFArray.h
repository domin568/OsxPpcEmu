 ...
 */
typedef CALLBACK_API_C( const void *, CFArrayRetainCallBack )(CFAllocatorRef allocator, const void *value);
typedef CALLBACK_API_C( void , CFArrayReleaseCallBack )(CFAllocatorRef allocator, const void *value);
typedef CALLBACK_API_C( CFStringRef , CFArrayCopyDescriptionCallBack )(const void * value);
typedef CALLBACK_API_C( Boolean , CFArrayEqualCallBack )(const void *value1, const void *value2);
 ...
 */
typedef CALLBACK_API_C( void , CFArrayApplierFunction )(const void *value, void *context);
