...
NewStyleRunDirectionUPP(StyleRunDirectionProcPtr userRoutine);
  ...
  #ifdef __cplusplus
    inline StyleRunDirectionUPP NewStyleRunDirectionUPP(StyleRunDirectionProcPtr userRoutine) { return (StyleRunDirectionUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppStyleRunDirectionProcInfo, GetCurrentArchitecture()); }
  #else
...
#if !OPAQUE_UPP_TYPES
  #ifdef __cplusplus
    inline void DisposeStyleRunDirectionUPP(StyleRunDirectionUPP userUPP) { DisposeRoutineDescriptor((UniversalProcPtr)userUPP); }
  #else
...
#if !OPAQUE_UPP_TYPES
  #ifdef __cplusplus
    inline Boolean InvokeStyleRunDirectionUPP(short styleRunIndex, void * dirParam, StyleRunDirectionUPP userUPP) { return (Boolean)CALL_TWO_PARAMETER_UPP(userUPP, uppStyleRunDirectionProcInfo, styleRunIndex, dirParam); }
  #else
