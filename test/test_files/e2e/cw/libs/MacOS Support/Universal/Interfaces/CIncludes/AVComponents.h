...
AVPanelComponentGetFocusStatus(
  ComponentInstance   panelComponent,
  Boolean *           hasFocus)                               FIVEWORDINLINE(0x2F3C, 0x0004, 0x0106, 0x7000, 0xA82A);
...
AVPanelComponentSetFocusStatus(
  ...
  Boolean *           tookFocus)                              FIVEWORDINLINE(0x2F3C, 0x000E, 0x0107, 0x7000, 0xA82A);
...
AVPortCheckTimingMode(
  ...
  VDDetailedTimingPtr       theDetailedTiming)                FIVEWORDINLINE(0x2F3C, 0x0010, 0x0000, 0x7000, 0xA82A);
...
AVPortGetDisplayTimingInfo(
  ...
  VDDetailedTimingPtr      theDetailedTiming)                 FIVEWORDINLINE(0x2F3C, 0x0010, 0x0200, 0x7000, 0xA82A);
...
AVPortGetIndexedDisplayProfile(
  ...
  UInt32              profileIndex,
  UInt32              profileSeed,
  CMProfileRef *      indexedProfile)                         FIVEWORDINLINE(0x2F3C, 0x0010, 0x0202, 0x7000, 0xA82A);
...
AVPortGetIndexedDisplayTiming(
  ...
  UInt32                timingIndex,
  UInt32                timingsSeed,
  VDDetailedTimingPtr   indexedTiming)                        FIVEWORDINLINE(0x2F3C, 0x0010, 0x0205, 0x7000, 0xA82A);
...
AVPortGetDisplayTimingRangeCount(
  ...
  void *              reserved,
  UInt32 *            rangeCount,
  UInt32 *            rangeSeed)                              FIVEWORDINLINE(0x2F3C, 0x000C, 0x0206, 0x7000, 0xA82A);
...
AVPortGetIndexedDisplayTimingRange(
  ...
  UInt32                    rangeIndex,
  UInt32                    rangeSeed,
  VDDisplayTimingRangePtr   indexedRange)                     FIVEWORDINLINE(0x2F3C, 0x0010, 0x0207, 0x7000, 0xA82A);
...
EXTERN_API( ComponentResult )
AVDeviceGetName(
  ComponentInstance   deviceComponent,
