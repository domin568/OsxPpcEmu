...
NewDSpEventUPP(DSpEventProcPtr userRoutine);
  ...
  #ifdef __cplusplus
    inline DSpEventUPP NewDSpEventUPP(DSpEventProcPtr userRoutine) { return userRoutine; }
  #else
...
NewDSpCallbackUPP(DSpCallbackProcPtr userRoutine);
  ...
  #ifdef __cplusplus
    inline DSpCallbackUPP NewDSpCallbackUPP(DSpCallbackProcPtr userRoutine) { return userRoutine; }
  #else
...
#if !OPAQUE_UPP_TYPES
  #ifdef __cplusplus
    inline Boolean InvokeDSpEventUPP(EventRecord * inEvent, DSpEventUPP userUPP) { return (*userUPP)(inEvent); }
  #else
...
#if !OPAQUE_UPP_TYPES
  #ifdef __cplusplus
    inline Boolean InvokeDSpCallbackUPP(DSpContextReference inContext, void * inRefCon, DSpCallbackUPP userUPP) { return (*userUPP)(inContext, inRefCon); }
  #else
