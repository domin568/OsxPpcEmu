/*
     ...
     Copyright:  й 1993-2002 by Apple Computer, Inc. and Mentat Inc., all rights reserved.
...
/* еее useful header comment please еее*/
...
#endif
EXTERN_API_C( void )
mps_intr_disable(MPS_INTR_STATE * oldState)                   THIRTEENWORDINLINE(0x40C0, 0xE040, 0x007C, 0x0600, 0x027C, 0xFEFF, 0x1080, 0x0200, 0x0070, 0x0C00, 0x0070, 0x6602, 0xA9FF);
...
#endif
EXTERN_API_C( void )
mps_intr_enable(MPS_INTR_STATE * oldState)                    WORDINLINE(0x40C0, 0x0240, 0x0700, 0x0C40, 0x0600, 0x6702, 0xA9FF, 0x1010, 0x0200, 0x0070, 0x0C00, 0x0070, 0x6602, 0xA9FF, 0x1010, 0xE140, 0x46C0);
...
/*
   ...
   memory in the OT kernel pool.  See Technote ееее "Understanding
