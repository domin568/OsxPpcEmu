...
typedef CALLBACK_API_C( const void *, CFSetRetainCallBack )(CFAllocatorRef allocator, const void *value);
typedef CALLBACK_API_C( void , CFSetReleaseCallBack )(CFAllocatorRef allocator, const void *value);
typedef CALLBACK_API_C( CFStringRef , CFSetCopyDescriptionCallBack )(const void * value);
typedef CALLBACK_API_C( Boolean , CFSetEqualCallBack )(const void *value1, const void *value2);
...
typedef CALLBACK_API_C( void , CFSetApplierFunction )(const void *value, void *context);
