...
#if TYPE_LONGLONG
  #ifdef __cplusplus
    inline SInt64 S64Divide(SInt64 dividend, SInt64 divisor, SInt64 *remainder) { return ((remainder) ? (*((SInt64*)(remainder)) = ((SInt64)(dividend) % (SInt64)(divisor))) : 0), ((SInt64)(dividend) / (SInt64)(divisor)); }
  #else
    #define S64Divide(dividend, divisor, remainder) (((remainder) ? (*((SInt64*)(remainder)) = ((SInt64)(dividend) % (SInt64)(divisor))) : 0), ((SInt64)(dividend) / (SInt64)(divisor)))
  #endif
#endif
...
#if TYPE_LONGLONG
  #ifdef __cplusplus
    inline UInt64 U64Divide(UInt64 dividend, UInt64 divisor, UInt64 *remainder) { return ((remainder) ? (*((UInt64*)(remainder)) = ((UInt64)(dividend) % (UInt64)(divisor))) : 0), ((UInt64)(dividend) / (UInt64)(divisor)); }
  #else
    #define U64Divide(dividend, divisor, remainder) (((remainder) ? (*((UInt64*)(remainder)) = ((UInt64)(dividend) % (UInt64)(divisor))) : 0), ((UInt64)(dividend) / (UInt64)(divisor)))
  #endif
#endif
