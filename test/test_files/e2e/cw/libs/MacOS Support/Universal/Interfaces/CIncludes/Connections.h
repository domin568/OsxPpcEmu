...
NewConnectionToolDefUPP(ConnectionToolDefProcPtr userRoutine);
  ...
  #ifdef __cplusplus
    inline ConnectionToolDefUPP NewConnectionToolDefUPP(ConnectionToolDefProcPtr userRoutine) { return (ConnectionToolDefUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppConnectionToolDefProcInfo, GetCurrentArchitecture()); }
  #else
...
NewConnectionSearchCallBackUPP(ConnectionSearchCallBackProcPtr userRoutine);
  ...
  #ifdef __cplusplus
    inline ConnectionSearchCallBackUPP NewConnectionSearchCallBackUPP(ConnectionSearchCallBackProcPtr userRoutine) { return (ConnectionSearchCallBackUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppConnectionSearchCallBackProcInfo, GetCurrentArchitecture()); }
  #else
...
NewConnectionCompletionUPP(ConnectionCompletionProcPtr userRoutine);
  ...
  #ifdef __cplusplus
    inline ConnectionCompletionUPP NewConnectionCompletionUPP(ConnectionCompletionProcPtr userRoutine) { return (ConnectionCompletionUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppConnectionCompletionProcInfo, GetCurrentArchitecture()); }
  #else
...
NewConnectionChooseIdleUPP(ConnectionChooseIdleProcPtr userRoutine);
  ...
  #ifdef __cplusplus
    inline ConnectionChooseIdleUPP NewConnectionChooseIdleUPP(ConnectionChooseIdleProcPtr userRoutine) { return (ConnectionChooseIdleUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppConnectionChooseIdleProcInfo, GetCurrentArchitecture()); }
  #else
...
#if !OPAQUE_UPP_TYPES
  #ifdef __cplusplus
    inline void DisposeConnectionToolDefUPP(ConnectionToolDefUPP userUPP) { DisposeRoutineDescriptor((UniversalProcPtr)userUPP); }
  #else
...
#if !OPAQUE_UPP_TYPES
  #ifdef __cplusplus
    inline void DisposeConnectionSearchCallBackUPP(ConnectionSearchCallBackUPP userUPP) { DisposeRoutineDescriptor((UniversalProcPtr)userUPP); }
  #else
...
#if !OPAQUE_UPP_TYPES
  #ifdef __cplusplus
    inline void DisposeConnectionCompletionUPP(ConnectionCompletionUPP userUPP) { DisposeRoutineDescriptor((UniversalProcPtr)userUPP); }
  #else
...
#if !OPAQUE_UPP_TYPES
  #ifdef __cplusplus
    inline void DisposeConnectionChooseIdleUPP(ConnectionChooseIdleUPP userUPP) { DisposeRoutineDescriptor((UniversalProcPtr)userUPP); }
  #else
...
#if !OPAQUE_UPP_TYPES
  #ifdef __cplusplus
    inline long InvokeConnectionToolDefUPP(ConnHandle hConn, short msg, long p1, long p2, long p3, ConnectionToolDefUPP userUPP) { return (long)CALL_FIVE_PARAMETER_UPP(userUPP, uppConnectionToolDefProcInfo, hConn, msg, p1, p2, p3); }
  #else
...
#if !OPAQUE_UPP_TYPES
  #ifdef __cplusplus
    inline void InvokeConnectionSearchCallBackUPP(ConnHandle hConn, Ptr matchPtr, long refNum, ConnectionSearchCallBackUPP userUPP) { CALL_THREE_PARAMETER_UPP(userUPP, uppConnectionSearchCallBackProcInfo, hConn, matchPtr, refNum); }
  #else
...
#if !OPAQUE_UPP_TYPES
  #ifdef __cplusplus
    inline void InvokeConnectionCompletionUPP(ConnHandle hConn, ConnectionCompletionUPP userUPP) { CALL_ONE_PARAMETER_UPP(userUPP, uppConnectionCompletionProcInfo, hConn); }
  #else
...
#if !OPAQUE_UPP_TYPES
  #ifdef __cplusplus
    inline void InvokeConnectionChooseIdleUPP(ConnectionChooseIdleUPP userUPP) { CALL_ZERO_PARAMETER_UPP(userUPP, uppConnectionChooseIdleProcInfo); }
  #else
