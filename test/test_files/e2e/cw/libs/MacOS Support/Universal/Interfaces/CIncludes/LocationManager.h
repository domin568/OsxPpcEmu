...
NewALMNotificationUPP(ALMNotificationProcPtr userRoutine);
  ...
  #ifdef __cplusplus
    inline ALMNotificationUPP NewALMNotificationUPP(ALMNotificationProcPtr userRoutine) { return (ALMNotificationUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppALMNotificationProcInfo, GetCurrentArchitecture()); }
  #else
...
#if !OPAQUE_UPP_TYPES
  #ifdef __cplusplus
    inline void DisposeALMNotificationUPP(ALMNotificationUPP userUPP) { DisposeRoutineDescriptor((UniversalProcPtr)userUPP); }
  #else
...
#if !OPAQUE_UPP_TYPES
  #ifdef __cplusplus
    inline void InvokeALMNotificationUPP(AppleEvent * theEvent, ALMNotificationUPP userUPP) { CALL_ONE_PARAMETER_UPP(userUPP, uppALMNotificationProcInfo, theEvent); }
  #else
...
EXTERN_API( OSErr )
ALMRegisterNotifyProc(
  ALMNotificationUPP           notificationProc,
