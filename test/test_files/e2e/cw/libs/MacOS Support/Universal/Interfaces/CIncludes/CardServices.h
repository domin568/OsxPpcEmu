...
NewPCCardCSClientUPP(PCCardCSClientProcPtr userRoutine);
  ...
  #ifdef __cplusplus
    inline PCCardCSClientUPP NewPCCardCSClientUPP(PCCardCSClientProcPtr userRoutine) { return (PCCardCSClientUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppPCCardCSClientProcInfo, GetCurrentArchitecture()); }
  #else
...
#if !OPAQUE_UPP_TYPES
  #ifdef __cplusplus
    inline void DisposePCCardCSClientUPP(PCCardCSClientUPP userUPP) { DisposeRoutineDescriptor((UniversalProcPtr)userUPP); }
  #else
...
EXTERN_API_C( UInt16 )
InvokePCCardCSClientUPP(
  ClientCallbackPBPtr  ccPBPtr,
  PCCardCSClientUPP    userUPP);
#if !OPAQUE_UPP_TYPES
  #ifdef __cplusplus
    inline UInt16 InvokePCCardCSClientUPP(ClientCallbackPBPtr ccPBPtr, PCCardCSClientUPP userUPP) { return (UInt16)CALL_ONE_PARAMETER_UPP(userUPP, uppPCCardCSClientProcInfo, ccPBPtr); }
  #else
