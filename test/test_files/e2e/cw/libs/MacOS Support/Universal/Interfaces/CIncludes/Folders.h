...
FSFindFolderExtended(
  ...
  UInt32    flags,
  void *    data,
  FSRef *   foundRef)                                         TWOWORDINLINE(0x7035, 0xA823);
...
enum {
  ...
  kMusicDocumentsFolderType     = FOUR_CHAR_CODE('µdoc'), /* Refers to the "Music" folder in a users home directory*/
...
enum {
  kAppleshareAutomountServerAliasesFolderType = FOUR_CHAR_CODE('srvÄ'), /* Appleshare puts volumes to automount inside this folder. */
  kPreMacOS91ApplicationsFolderType = FOUR_CHAR_CODE('Œpps'), /* The "Applications" folder, pre Mac OS 9.1 */
  kPreMacOS91InstallerLogsFolderType = FOUR_CHAR_CODE('”lgf'), /* The "Installer Logs" folder, pre Mac OS 9.1 */
  kPreMacOS91AssistantsFolderType = FOUR_CHAR_CODE('ŒstÄ'), /* The "Assistants" folder, pre Mac OS 9.1 */
  kPreMacOS91UtilitiesFolderType = FOUR_CHAR_CODE('ŸtiÄ'), /* The "Utilities" folder, pre Mac OS 9.1 */
  kPreMacOS91AppleExtrasFolderType = FOUR_CHAR_CODE('ŒexÄ'), /* The "Apple Extras" folder, pre Mac OS 9.1 */
  kPreMacOS91MacOSReadMesFolderType = FOUR_CHAR_CODE('µorÄ'), /* The "Mac OS ReadMes" folder, pre Mac OS 9.1 */
  kPreMacOS91InternetFolderType = FOUR_CHAR_CODE('”ntÄ'), /* The "Internet" folder, pre Mac OS 9.1 */
  kPreMacOS91AutomountedServersFolderType = FOUR_CHAR_CODE('§rvÄ'), /* The "Servers" folder, pre Mac OS 9.1 */
...
NewFolderManagerNotificationUPP(FolderManagerNotificationProcPtr userRoutine);
  ...
  #ifdef __cplusplus
    inline FolderManagerNotificationUPP NewFolderManagerNotificationUPP(FolderManagerNotificationProcPtr userRoutine) { return (FolderManagerNotificationUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppFolderManagerNotificationProcInfo, GetCurrentArchitecture()); }
  #else
...
#if !OPAQUE_UPP_TYPES
  #ifdef __cplusplus
    inline void DisposeFolderManagerNotificationUPP(FolderManagerNotificationUPP userUPP) { DisposeRoutineDescriptor((UniversalProcPtr)userUPP); }
  #else
...
#if !OPAQUE_UPP_TYPES
  #ifdef __cplusplus
    inline OSStatus InvokeFolderManagerNotificationUPP(OSType message, void * arg, void * userRefCon, FolderManagerNotificationUPP userUPP) { return (OSStatus)CALL_THREE_PARAMETER_UPP(userUPP, uppFolderManagerNotificationProcInfo, message, arg, userRefCon); }
  #else
